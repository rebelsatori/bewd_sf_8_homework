...
puts "Welcome to my secret number game.  You'll have three tries to guess my secret number."

# TODO: put code here ask the user for their name, and save it in a Player object.

puts "Please enter you name:"
#create a new player based on the input
player = Player.new
player.player_name = gets.chomp

# TODO: put code here to initialize a new Game object, and start it
#start the game, pass in a new secret number and player name.  call .play on Game.
Game.new(SecretNumber.new.secret, player).play
